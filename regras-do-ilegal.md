...
3. **Conflitos no Discord Ilegal:** É estritamente proibida qualquer forma de discussão ou provocação no chat destinado aos líderes.
4. **Tabelas de Preços:** É proibida a comercialização de produtos com valores diferentes dos estabelecidos na Tabela Oficial (disponível no Discord Ilegal). Também é proibida a compra de itens de outra organização para revenda a terceiros.

{% hint style="info" %}
**Novas Facções:** Facções recém-criadas dispõem de um prazo de 15 dias para se estruturar e se estabelecer na cidade.
{% endhint %}
...
> Se o integrante estiver ativo na cidade, mas inativo na facção, será obrigatória a realização de Roleplay para sua captura e aplicação do PD previsto.
...
* Camperar: É proibido camperar locais de farm, QGs (P1 e P2) e favelas.

## &#x20;Regras de Engajamento

* [x] **Áreas de Risco:** Locais como pontos de venda de drogas, QGs, favelas e negociações clandestinas não possuem PvP liberado. É obrigatório iniciar Roleplay antes de qualquer confronto.
* [x] **Prazos de Ações:** Todas as ações iniciadas em pista possuem prazo máximo de 24 horas para conclusão, sendo obrigatório manter o registro completo (gravação/provas) da ação.
* [x] **Fuga Limpa e Resgates:** Fugas limpas (como caixas eletrônicos e corridas ilegais) pressupõem a ausência de disparos ou confronto direto. Não é permitido realizar qualquer tipo de resgate com o uso de armas nessas situações.
* [x] **Ações com Reféns:** Em situações com reféns, **é obrigatório** o uso dos itens algemas e capuz.
